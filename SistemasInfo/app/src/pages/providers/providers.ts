...
import { AddproviderPage } from '../functions/providers/add-provider/add-provider';
import { HttpClient } from '@angular/common/http';
import { ToastController } from 'ionic-angular';
import { DeleteProviderPage } from '../functions/providers/delete-provider/delete-provider';
import { EditProviderPage } from '../functions/providers/edit-provider/edit-provider';
...
export class ProvidersPage {
  ...
  constructor(public navCtrl: NavController, public http: HttpClient, public toast: ToastController) {
    ...
    this.http.get("http://172.10.20.194/IonicApp/json_fetch_providers.php").subscribe(data => {
      this.elements = data;
