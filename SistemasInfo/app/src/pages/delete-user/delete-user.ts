...
import { DeleteUserActionPage } from '../functions/users/delete-user-action/delete-user-action';
import { EditUserActionPage } from '../functions/users/edit-user-action/edit-user-action';
...
export class DeleteUserPage {
    ...
    getData() {
        this.httpC.get("http://172.10.20.194/IonicApp/json_fetch_user.php").subscribe(data => {
            this.elements = data;
            console.log(data);
        }, err => {
            console.log(err);
